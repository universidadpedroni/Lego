function [L, type] = dubinRSR(s, g, r_turn_min)
    ...
    if D < 2 * r_turn_min
        warning('La trayectoria RSR no es válida para los puntos dados.');
        L = [-1 -1 -1];
        return
    end
    ...
    theta2_arc = checkAngles(theta2_arc, 'R');
